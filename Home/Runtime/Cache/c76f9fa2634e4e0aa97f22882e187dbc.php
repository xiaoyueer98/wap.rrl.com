        ...
        <form action='/index.php?s=/Company/send_job_text' method='post'>
            <section class="content m-content1" style="padding-bottom:20px;display:block">
                ...
                <div class="com-list" style="margin-top:30px;">
                    ...
                    <div class="bd">
                        <div class="list m" id="com-bkgd"><em class="m">公司背景：</em><span><?php echo $result['match_companydata']?></span><input type='hidden' name='match_company' value="<?php echo $result['match_company']?>"><input type='hidden' name='match_companydata' value="<?php echo $result['match_companydata']?>"></div>
                    </div>
                ...
                <div class="com-list" style="margin-top:30px;">
                    ...
                    <div class="bd">
                        <div class="list"><em class="m">截止时间</em><input type="text" name="jobendtime" placeholder="格式：2015-07-21" value="<?php echo $result['jobendtime']?>"></div>
                    </div>
                </div>
                ...
                <div class="com-list">
                    <div class="bd">
                        <div class="list" id="com-nature"><em class="m" style="width:120px;">您的默认联系方式为 :</em><span class="wh100 cl2"><?php echo $result['mobile']?></span></div>
                    </div>
                    <div class="">
                        <div class="list" id="com-nature"><em style="width:130px;">是否使用其他联系方式 :</em><label id="m-tre" for="" ></label><input type='hidden' value="<?php echo $result['meth']?>" name='meth'></div>
                    </div>
                    <div class="m-phone">
                        <div class="bd">
        ...
        $("#baocun").click(function () {
            ...
            $.post("/index.php?s=/Company/send_job_save", {
                ...
                if (data.code != "200") {
                    ...
                    $("[name='title']").val("");
                    $('[name="industry"]').val("");$("#com-industry span").html("");
                    $('[name="category"]').val("");$("#com-category span").html("");
                    $('[name="place"]').val("");$("#com-place span").html("");
                    $('[name="employ"]').val("");

                    $('[name="treatment"]').val("");$("#com-salary span").html("");
                    $('[name="match_industry"]').val("");$("#com-subdivide span").html("");
                    $('[name="match_company"]').val("");$("#com-bkgd span").html("");

                    $('[name="report_obj"]').val("");
                    $('[name="report_number"]').val("");
                    $('[name="jobendtime"]').val("");

                    $('[name="workdesc"]').val("");$("#workdesc span").html("");
                    $('[name="content"]').val("");$("#content span").html("");

                    $('[name="education"]').val("");$("#com-education span").html("");
                    $('[name="joblang"]').val("");$("#com-language span").html("");
                    $('[name="experience"]').val("");$("#com-experience").html("");
