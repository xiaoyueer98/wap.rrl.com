...
<html lang="en">
    <head>
        ...
        <script type="text/javascript" src="/Public/js/left_nav.js"></script>
    ...
    <body style="overflow:hidden">
        ...
        <div class="left_nav">
            ...
            <div id="c" class="c">
                <ul>
                    <li class="dis_box cur"><span class="flex">首&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp页</span><em><img src="/Public/images/right_jt.png" alt=""></em></li>
...
<?php } ?>
                    ...
                    <div class="silder-banner">
                        <div class="swiper-container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide"><a href="/index.php?s=/Customized/index"><img src="/Public/images/4.png" alt=""></a></div>
                    ...
                    <div class="sbanner dis_box">
                        <span class="flex"><img onclick="location.href = '/index.php?s=/Customized/index.html'" src="/Public/images/hd2.png" alt=""></span>
                        <span class="flex" style="margin:0 10px"><img  onclick="location.href = '/index.php?s=/Salon/salon_list.html'" src="/Public/new-images/salonin.png" alt=""></span>
<!--                        <?php if(!empty($_SESSION['cuserinfo'])):?>
                        <span class="flex paihang"><img onclick="like_alert('您是企业账号，请登录推荐人账号再试！')" src="/Public/images/hd3.png" alt=""></span>
                        <?php else:?>
                        <span class="flex paihang"><img onclick="location.href = '/index.php?s=/Job/add_resume'" src="/Public/images/hd3.png" alt=""></span>
                        <?php endif;?>-->
                        <span class="flex paihang"><img onclick="location.href = '/index.php?s=/Upresume/index.html'" src="/Public/images/hd3.png" alt=""></span>
                    </div>
                    <div class="search">
                        <div class=" clearfix">
...
<?php } ?>
                        ...
                        <div class="dis_box">
                            <div class=" dis_box orient aligncenter">
                                <dl class="dis_box orient aligncenter">
                                    <dt><img src="/Public/images/fxxk-logo.png" alt=""></dt>
                                    <dd><h5>分享销客</h5></dd>
                                    <dd><h6>(D轮)</h6></dd>
                                    <dd><p>2014年7月完成由北极光领头的B轮融资，同年11月完成由DCM领投5千万美金的C轮，2015年6月完成D轮融资（以一年之内完成B、C、D三轮融资的速度震惊了互联网市场），目前团队已达到1000人规模。通过人人猎平台成功招到iOS人才。</p>
                                    </dd>
                                </dl>
                            </div>
                            <div class=" dis_box orient aligncenter" style="margin-right:1%;">
                                <dl class="dis_box orient aligncenter">
                                    <dt><img src="/Public/images/cm-logo.png" alt=""></dt>
                                    <dd><h5>慈铭</h5></dd>
                                    <dd><h6>(自有资金)</h6></dd>
                                    <dd><p>慈铭健康体检管理集团股份有限公司是一家按照“早诊断、早发现、早治疗”暨“预防为主”的医学思想创建的以健康体检为主营业务的连锁化经营的专业体检机构。通过人人猎平台成功招到高级java工程师。</p>
                                    </dd>
                                </dl>
                            </div>
                        </div>
                        <div class="dis_box">
                            <div class=" dis_box orient aligncenter">
                                <dl class="dis_box orient aligncenter">
                                    <dt><img src="/Public/images/51sb-logo.png" alt=""></dt>
                                    <dd><h5>51社保</h5></dd>
                                    <dd><h6>(A轮)</h6></dd>
                                    <dd><p>51社保网隶属北京众合天下管理咨询有限公司旗下，是中国最大的社保专业网站，中国领先的社保实务品牌，中国互联网社保服务领跑者。在人人猎平台成功招到PHP人才。</p></dd>
                                </dl>
                            </div>
                            <div class=" dis_box orient aligncenter" style="margin-right:1%;">
                                <dl class="dis_box orient aligncenter">
                                    <dt><img src="/Public/images/zhb-logo.png" alt=""></dt>
                                    <dd><h5>智汇邦</h5></dd>
                                    <dd><h6>(自有资金)</h6></dd>
                                    <dd><p>智汇邦是权威的海内外高层次人才数据库和高端人才在线社交平台，旨在为高层次人才在华创新创业搭建桥梁，为其职业和事业发展提供快速便捷的服务。在人人猎平台成功招到产品总监。</p>
                                    </dd>
                                </dl>
                            </div>
                        </div>
...
<?php } ?>
                ...
                <div id="cn2" class="cn2 dis_none flex">
                    <div class="posit">
                        ...
                        <h4>3.批量招聘优势明显</h4>
                        <p>经咨询，猎头公司和招聘公司短期内批量招聘（如销售代表等职位）较难招齐<br>经询价，普通岗位批量招聘单人成本为： 猎头3000元+ 招聘公司 1500元+<br>比较： 批量招聘成本更低、推荐源更广、速度更快</p>
                    </div>
                </div>
...
<?php } ?>
                    ...
                    <div class="scrol">
                        ...
                        <p style="margin-bottom:10px;">投资人关系 <br>
                            ir@renrenlie.com <br>
                        </p>
