                ...
                <div class="clearfix" style="padding-bottom:40px;">
                    ...
                    <div class="user" style="display:block;">
                        ...
                        <div class="user-data">
                            <dl class="user-con clearfix">
                                <dt class="dis-block dis-inlin fl-lef">
                                    <img src="/Public/images/company-logo.png" alt="">
                                </dt>
                                <dd class="dis-block dis-inlin fl-lef">
                                    <span class="dis-block dis-inlin"><?php echo $_SESSION['cuserinfo']['username']?></span>
                                    <span class="dis-block dis-inlin">18500521769</span>
                                    <span class="dis-block dis-inlin">北京众聘科技有限公司</span>
                                    <span class="dis-block dis-inlin">francis_fh@163.com</span>
                                </dd>
                                <span class="date">
                                    888
                                </span>
                        ...
                        <div class="div-list div-list1">
                            ...
                            <p class="clearfix"><span>1.企业基本资料需要完善</span></p>
                            <p class="clearfix"><span>2.需要签订合同</span></p>
                            <p class="clearfix"><span>3.还没发布职位</span></p>
                            <p class="clearfix"><span>4.查看候选人简历</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp2"></span><em>人才</em></div>
                            <p class="clearfix"><span class="back-none">1.候选人简历：<b>4</b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.发布职位：<b>10</b>个；</span></p>
                            <p class="clearfix"><span class="back-none">3.累积支付费用：<b>1000</b>元；</span></p>
                            <p class="clearfix"><span class="back-none">4.累积入职人数：<b>1000</b>人；</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp3"></span><em>进程</em></div>
                            <p class="clearfix"><span class="back-none">1.新收到的候选人简历：<b>5</b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.进入待付款状态的候选人：<b>5</b>个；</span></p>
                        </div>
                    </div>
                    <div class="l-c-n">
                    ...
                    <div class="user" style="display:block">
                        ...
                        <div class="user-data">
                            <dl class="user-con clearfix">
                                ...
                                <dd class="dis-block dis-inlin fl-lef">
                                    <span class="dis-block dis-inlin">沙皮狗的忧伤</span>
                                    <span class="dis-block dis-inlin">18500521769</span>
                                    <span class="dis-block dis-inlin">北京众聘科技有限公司</span>
                                    <span class="dis-block dis-inlin">francis_fh@163.com</span>
                                </dd>
                        ...
                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp1"></span><em>任务</em></div>
                            <p class="clearfix"><span>1.个人基本资料需要完善</span></p>
                            <p class="clearfix"><span>2.还没验证手机号</span></p>
                            <p class="clearfix"><span>3.简历库（候选人）还没有</span></p>
                            <p class="clearfix"><span>4.快去为候选人推荐合适的职位吧</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp4"></span><em>财富</em></div>
                            <p class="clearfix"><span class="back-none">1.简历库：<b>4</b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.推荐次数：<b>10</b>次；</span></p>
                            <p class="clearfix"><span class="back-none">3.累积收益：1000<b>1000</b>元；</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp3"></span><em>进程</em></div>
                            <p class="clearfix"><span class="back-none">1.正在面试进程中的候选人：<b>3</b>个；</span></p>
                            <p class="clearfix"><span class="back-none">2.进入待付款状态的候选人：<b>5</b>个；</span></p>
                        </div>
                    </div>
                    <div class="l-c-n">
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            $.each(data, function (i, val) {
                                var str = '';
                                str = '<a href="/index.php?s=/Job/job_detail_new/jobid/<?php echo ($vo["id"]); ?>">'
                                        + '<ul class="latest-position">'
                                        + '<li class="clearfix lis1">'
                                        + '<div class="fl-lef dis-inlin">'
