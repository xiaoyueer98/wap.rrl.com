                ...
                <div class="clearfix" style="padding-bottom:40px;">
                    ...
                    <div class="user">
                        ...
                        <div class="div-list div-list1">
                            ...
                            <p class="clearfix"><span style='color:#343434'>暂无任务</span></p>
                            <?php else:?>
                        ...
                        <div class="div-list div-list1">
                            ...
                            <p class="clearfix"><span class="back-none">1.候选人简历：<b><?php echo $resumeCount?></b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.发布职位：<b><?php echo $jobCount?></b>个；</span></p>
                            <p class="clearfix"><span class="back-none">3.累积支付费用：<b><?php echo $sumFee;?></b>元；</span></p>
                            <p class="clearfix"><span class="back-none">4.累积入职人数：<b><?php echo $isSucCount;?></b>人；</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp3"></span><em>进程</em></div>
                            <p class="clearfix"><span class="back-none">1.新收到的候选人简历：<b><?php echo $newRecordCount; ?></b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.进入待付款状态的候选人：<b><?php echo $isSinkCount; ?></b>个；</span></p>
                        </div>
                    </div>
                    <div class="l-c-n">
                    ...
                    <div class="user" style="display:block">
                        ...
                        <div class="user-data">
                            <dl class="user-con clearfix">
                                ...
                                <dd class="dis-block dis-inlin fl-lef">
                                    <span class="dis-block dis-inlin" style='margin-top:10px;'><?php echo $arUserinfo['username'];?></span>
                        ...
                        <div class="div-list div-list1">
                            ...
                            <p class="clearfix"><span class="back-none">1.简历库：<b><?php echo $resumeCount;?></b>份；</span></p>
                            <p class="clearfix"><span class="back-none">2.推荐次数：<b><?php echo $recordCount;?></b>次；</span></p>
                            <p class="clearfix"><span class="back-none">3.累积收益：<b><?php echo $feeCount;?></b>元；</span></p>
                        </div>

                        <div class="div-list div-list1">
                            <div class="lt clearfix"><span class="sp3"></span><em>进程</em></div>
                            <p class="clearfix"><span class="back-none">1.正在面试进程中的候选人：<b><?php echo $isAudstartCount;?></b>个；</span></p>
                            <p class="clearfix"><span class="back-none">2.进入待付款状态的候选人：<b><?php echo $isSinkCount;?></b>个；</span></p>
                        </div>
                    </div>
                    <div class="l-c-n">
