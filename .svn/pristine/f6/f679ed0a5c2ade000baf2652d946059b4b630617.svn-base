...
class UpresumeAction extends Action {
        ...
        function index() {
                ...
                if(empty($arShare)){
                      $arShare['wapurl']  = "http://m.renrenlie.com/index.php?s=/Upresume/index.html";
         ...
         */
        function index_back() {
                header("location:/index.php?s=/Upresume/index");die;
                //为引入的头部传入标题
                $lArr = array(
                    array("name" => "回到首页", "url" => "/", "img" => "/Public/new-images/head-icon/m-icon1.png"),
                    array("name" => "上传简历", "url" => "/index.php?s=/Upresume/index", "img" => "/Public/new-images/head-icon/scjl.png"),
        ...
        function send_msg() {
                ...
                if (!$_SESSION['up_leveltime']) {
                        ...
                        $gets = sendMessageOld($mobile, $content, $link_id, $tag, $comment);
                        if ($gets['code'] == 200) {
